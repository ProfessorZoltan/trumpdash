...
const CACHE = 'trumpdash-v4';
const PRECACHE = [
  './', 'index.html', 'style.css', 'manifest.json', 'privacy.html',
  'src/constants.js', 'src/sprites.js', 'src/level.js',
  'src/levels/greenland.js', 'src/levels/venezuela.js', 'src/levels/hormuz.js', 'src/levels/canada.js', 'src/levels/panama.js', 'src/levels/moon.js', 'src/levels/qatar.js', 'src/levels/tutorial.js',
  'src/physics.js', 'src/audio.js', 'src/render.js', 'src/game.js',
  'resources/sprite_sheet.png', 'resources/walk_sheet.png', 'resources/greenland_map.png', 'resources/florida_map.png',
